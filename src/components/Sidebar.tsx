...
import { LayoutDashboard, Settings, User, MessageSquareMore, MessageSquareDiff, FileText, Edit, Book } from "lucide-react";
...
const menuList: MenuGroup[] = [
  {
    group: "Menu Geral",
    items: [
      { text: "Dashboard", icon: "LayoutDashboard", link: "/dashboard" },
    ],
  },
  {
    group: "Ferramentas",
      ...
      <div className="p-2">
        <div className="p-6 border border-gray-300 rounded-lg bg-gray-100 mt-4">
          <div className="w-20 h-20 mb-4 flex justify-center items-center">
            <Graph graph={graphData} options={graphOptions} events={graphEvents} />
          </div>
          <div className="w-20 h-20 mb-4 flex justify-center items-center">
            <Graph graph={graphData} options={graphOptions} events={graphEvents} />
          </div>
